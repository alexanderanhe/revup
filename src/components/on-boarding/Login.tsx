  ...
  return (
    <Fragment>
      <section className="flex justify-start items-center [&>p]:text-center [&>p]:text-lg gap-4">
        <div className={"absolute inset-0 blur bg-[url('/images/sHfo3WOgGTU-unsplash.webp')] bg-cover md:bg-contain bg-center bg-no-repeat z-[-1]"} />
        <Image
          src={logo}
      ...
      <footer className="grid grid-cols-1 place-items-center gap-2 pb-10">
        ...
        <p className="text-center">Al continuar acepta los terminos y condiciones de la aplicación</p>
      </footer>
    </Fragment>
  )
}